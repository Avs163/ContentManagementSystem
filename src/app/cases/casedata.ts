...
export function gettingData(dataCount?: number): object {
   ...
   let Court: string[] = ['SC Supreme Court', 'BHC Bombay High Court', 'CCSC City Civils & Sessions Court','MAG Magistrate Court','CONS Consumer Court','CAT']
   let Type: string[] = ['Criminal', 'Civil', 'Domestic', 'Probate/Guardianship', 'Adoption/Paternity', 'Mental Illness/Alcohol','Juvenile Dependency','Juvenile Offender','Judgment']
   let Mail: string[] = ['sample.com', 'arpy.com', 'rpy.com', 'mail.com', 'jourrapide.com']
   let Year: string[] = ['1999', '2010', '2012', '1986', '2005']
   let Date: string[] = ['20/11/1999', '03/07/2010', '12/12/2012', '15/08/1986', '01/01/2005']
   let ID: string[] = ['sample.com', 'arpy.com', 'rpy.com', 'mail.com', 'jourrapide.com']
   let Description: string[] = ['Energy', 'Financial', 'Technology', 'Industrial']
   let Name: string[] = ['Energy', 'Financial', 'Technology', 'Industrial']
   let DocType: string[] = ['Village Specimen', 'Accomodation Agreement', 'Extract', 'Account Statement','Email']
   let Location: string[] = ['93 1 00042 7', '95 3 00068 7', '86 5 00039 7', '99 1 00015 7', '97 4 00021 7']
   let Status: string[] = ['Active', 'Inactive'];
   let Access: string[] = ['Super Admin', 'Junior Admin', 'Manager','Staff Member'];
   let username: string[] = [];
   let password: string[] = [];
   let tradeData: any = [];
   ...
   let EmployeeImg = ['male', 'female','others'];
   ...
   for (let i: number = 1; i <= dataCount; i++) {
       ...
       tradeData.push({
           ...
           'Court': Court[Math.floor(Math.random() * Court.length)],
           ...
           'DocType': DocType[Math.floor(Math.random() * DocType.length)],
